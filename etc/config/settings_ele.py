...
flags = {
    ...
    'myWP' 		: '(passingTight80X == 1 && passingHLT == 1)'
    }
...
samplesDef = {
    'data'   : tnpSamples.Moriond17_80X['data_Run2016H2'].clone(),
...
samplesDef['data'].add_sample( tnpSamples.Moriond17_80X['data_Run2016H3'] )
...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('DY_madgraph_Winter17_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('DY_amcatnlo_Winter17_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('DY_madgraph_Winter17_ele.pu.puTree.root')
